    ...
    >
      ...
      <defs>
        {docked ? (
          ...
          >
            <stop offset="0%" stopColor={BRAND_GRAY} stopOpacity="1" />
            <stop offset="42%" stopColor={BRAND_GRAY} stopOpacity="1" />
            <stop offset="72%" stopColor={BRAND_GRAY} stopOpacity="0.5" />
            <stop offset="100%" stopColor={BRAND_GRAY} stopOpacity="0" />
          </linearGradient>
        ) : (
          <>
